...
exports.default = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('transition', { attrs: { "name": "modal-fade" } }, [_c('div', { directives: [{ name: "show", rawName: "v-show", value: _vm.visible, expression: "visible" }], staticClass: "ic-dialog", class: {
        ...
        } } }, [_c('div', { ref: "wrapper", staticClass: "ic-dialog__wrapper", style: { width: _vm.width, height: _vm.height, 'margin-top': _vm.marginTop } }, [_c('div', { staticClass: "ic-dialog__header" }, [_vm._t("header", [_c('ic-header', { attrs: { "left-icon": _vm.showClose ? 'titlebar-close' : '', "title": _vm.title }, on: { "click-left": function clickLeft($event) {
