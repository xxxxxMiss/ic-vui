...
exports.default = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "ic-input", class: ['ic-input--' + _vm.size, {
        ...
        } } }) : _vm._e(), _c('ic-icon', { directives: [{ name: "show", rawName: "v-show", value: _vm.showClearable, expression: "showClearable" }], staticClass: "ic-icon-suffix", style: { color: '#999' }, attrs: { "name": "clean" }, on: { "click": function click($event) {
