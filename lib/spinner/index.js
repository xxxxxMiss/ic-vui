...
exports.default = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "ic-spinner", class: ['ic-spinner--' + _vm.type, 'ic-spinner--' + _vm.size] }, [_vm.type === 'default' ? _c('span', { staticClass: "ic-spinner__inner", style: { color: _vm.colors[0] } }, _vm._l(12, function (i) {
      return _c('i', { key: i });
    })) : _vm._e(), _vm.type === 'circle' ? _c('span', { staticClass: "ic-spinner__inner", style: {
        'border-color': _vm.colors[0],
        'border-left-color': 'transparent'
      } }) : _vm._e(), _vm.type === 'gradient' ? _c('div', { staticClass: "ic-spinner__inner" }, [_c('div', { staticClass: "ic-spinner--gradient-left" }), _c('div', { staticClass: "ic-spinner--gradient-top" }), _c('div', { staticClass: "ic-spinner--gradient-bottom" }), _c('div', { staticClass: "ic-spinner--gradient-patch" })]) : _vm._e(), _vm.type === 'crash-ball' ? _c('span', { staticClass: "ic-spinner__inner" }, _vm._l(['top', 'right', 'bottom', 'left'], function (val, index) {
