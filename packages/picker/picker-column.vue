<template>
  <div class="ic-picker__slot"
    :class="classNames"
    :style="flexStyle">
    <div v-if="!divider"
      ref="wrapper"
      class="ic-picker__wrapper"
      :class="{ 'ic-picker--dragging': dragging }"
      :style="{ height: contentHeight + 'px' }">
      <div class="ic-picker__item"
        v-for="itemValue in mutatingValues"
        :class="{
          'ic-picker__item--selected': itemValue === currentValue
        }"
        :style="{
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      doOnValuesChange () {
        var el = this.$el
        var items = el.querySelectorAll('.ic-picker__item')
